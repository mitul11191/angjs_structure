...
jQuery(document).ready(function ($) {
  ...
  ======================================================*/
    if ($('#cp_side-menu-btn, #cp-close-btn').length) {
        $('#cp_side-menu-btn, #cp-close-btn').on('clickclick', function () {
...
======================================================*/
   ...
   ======================================================*/
    $(".video-menu").click(function () {
        $(".video-filter").toggleClass('show', 7000);
        $(".video-menu").toggleClass('close-menu');
        $(".creativeTalent-filter").removeClass('show');
        $(".creativeTalent-menu").removeClass('close-menu');
        $(".featured-filter").removeClass('show');
        $(".featured-menu").removeClass('close-menu');
        $(".locations-filter").removeClass('show');
        $(".locations-menu").removeClass('close-menu');
    });

    $(".creativeTalent-menu").click(function () {
        $(".creativeTalent-filter").toggleClass('show', 7000);
        $(".creativeTalent-menu").toggleClass('close-menu');
        $(".video-filter").removeClass('show');
        $(".video-menu").removeClass('close-menu');
        $(".featured-filter").removeClass('show');
        $(".featured-menu").removeClass('close-menu');
        $(".locations-filter").removeClass('show');
        $(".locations-menu").removeClass('close-menu');
    ...
    $(".featured-menu").click(function () {
        $(".featured-filter").toggleClass('show', 7000);
        $(".featured-menu").toggleClass('close-menu');
        $(".video-filter").removeClass('show');
        $(".video-menu").removeClass('close-menu');
        $(".creativeTalent-filter").removeClass('show');
        $(".creativeTalent-menu").removeClass('close-menu');
    ...
    $(".locations-menu").click(function () {
        $(".locations-filter").toggleClass('show', 7000);
        $(".locations-menu").toggleClass('close-menu');
        $(".video-filter").removeClass('show');
        $(".video-menu").removeClass('close-menu');
        $(".creativeTalent-filter").removeClass('show');
        $(".creativeTalent-menu").removeClass('close-menu');
